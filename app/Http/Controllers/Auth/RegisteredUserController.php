...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $mensagem = "Seja Bem vindo ao Sistema de Gestão de Bibliotecas do Itel, o seu pedido para alocar tua Biblioteca ao nosso Sistema de Gestão de Bibliotecas (BookItel) está sendo analisando, entraremos em contacto o mais rápido possivel";
