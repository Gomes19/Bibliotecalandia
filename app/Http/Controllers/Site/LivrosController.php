...
class LivrosController extends Controller
{
    ...
    public function livros_biblioteca($id){
        $dados['livro']=livrosbiblioteca::join('sub_categorias','livrosbibliotecas.id_sub_categoria','sub_categorias.id')
        ...
        ->where('livrosbibliotecas.id',$id)
        ->first();
        $d=  $dados['livro']->partileira;
        $dados['relacionados']=livrosbiblioteca::join('sub_categorias','livrosbibliotecas.id_sub_categoria','sub_categorias.id')
        ->join('categorias','livrosbibliotecas.id_categoria','categorias.id')
        ->join('partileiras','livrosbibliotecas.id_partileira','partileiras.id')
        ->join('bibliotecas','livrosbibliotecas.id_biblioteca','bibliotecas.id')
        ->select('sub_categorias.vc_nome as genero','categorias.vc_nome as categoria','livrosbibliotecas.*','partileiras.id as id_partileira','partileiras.vc_nome as partileira')
        ->where('partileiras.vc_nome',$d)
        ->get();
