...
// Relatorio dos Bibliotecas
Route::get('/relatorio_biblioteca', [App\Http\Controllers\Relatorios\BibliotecaController::class, 'index'])->name('relatorio.admin.biblioteca.index');
Route::post('/relatorio_biblioteca_store', [App\Http\Controllers\Relatorios\BibliotecaController::class, 'store'])->name('relatorio.admin.biblioteca.store');
