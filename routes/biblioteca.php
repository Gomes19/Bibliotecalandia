...
Route::middleware(['biblioteca'])->prefix('biblioteca')->group(function () {
    ...
    Route::get('/livros/cadastrar', [App\Http\Controllers\Biblioteca\LivrosController::class, 'create'])->name('biblioteca.livros.create');
    ...
    //Emprestimos
    Route::get('/emprestimos', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'index'])->name('biblioteca.emprestimo.index');
    Route::get('/emprestimos/cadastrar', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'create'])->name('biblioteca.emprestimo.create');
    Route::post('/emprestimos/store', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'store'])->name('biblioteca.emprestimo.store');
    Route::get('/emprestimos/entregue/{id}', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'entregar'])->name('biblioteca.emprestimo.entregar');


    //Carrinho
    Route::get('/carrinho', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'index'])->name('biblioteca.carrinho.index');
    Route::post('/carrinho/store', [App\Http\Controllers\Biblioteca\EmprestimoController::class, 'store'])->name('biblioteca.carrinho.store');
    ...
    Route::get('/biblioteca_relatorio_livro', [App\Http\Controllers\Relatorios\Biblioteca\LivrosController::class, 'index'])->name('relatorio.biblioteca.livros.index');
    Route::post('/biblioteca_relatorio_livro', [App\Http\Controllers\Relatorios\Biblioteca\LivrosController::class, 'store'])->name('relatorio.biblioteca.livros.store');
