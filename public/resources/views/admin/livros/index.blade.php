...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@zxing/library@0.18.3-esnext@zxing/library@0.18.3/esm5/index.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/@zxing/browser@0.18.3-esnext@zxing/browser@0.18.3/esm5/index.min.js"></script>
...
<div class="content-inner container-fluid pb-0" id="page_layout">
       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$livro->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.livros.delete', $livro->id)}}"">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$livro->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
                ...
                <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                         <h1>Scan de Código de Barras</h1>
    <div>
        <video id="video" width="300" height="200"></video>
        <canvas id="canvas" style="display:none;"></canvas>
        <button id="startButton">Scanear Código de Barras</button>
        <button id="stopButton" style="display:none;">Parar Scan</button>
    ...
    <input type="text" id="codigo_barras">
                 ...
                 <!-- Adicione a biblioteca QuaggaJS -->
    ...
    <script>
        ...
        codeReader.getVideoInputDevices()
            .then((videoInputDevices) => {
                if (videoInputDevices.length > 0) {
                    ...
                    video.srcObject = codeReader.decodeFromInputVideoDevice(selectedDeviceId, 'video')
                }
            })
            .catch((err) => {
                console.error(err)
        ...
        document.getElementById('startButton').addEventListener('click', () => {
            codeReader.decodeFromInputVideoDevice(selectedDeviceId, 'video', (result, err) => {
                if (result) {
                    console.log(result)
                    fetch(`https://www.googleapis.com/books/v1/volumes?q=isbn:${result.text}`)
                        ...
                        .then(data => {
                            if (data.totalItems > 0) {
                                ...
                                document.getElementById('ano_publicacao').value = livro.publishedDate || ''
                                codigo_barras.innerText = `Código de barras lido: ${result.text}`
                            } else {
                                codigo_barras.innerText = 'Nenhum resultado encontrado para o código de barras lido'
                            }
                        })
                        .catch(err => {
                            console.error(err)
