                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$user->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('biblioteca.user.delete', $user->id)}}"">
                                    <span class="btn-inner">
                    ...
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('biblioteca.user.update',$user->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                                @include('biblioteca.user.form')
                ...
                <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('biblioteca.user.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
