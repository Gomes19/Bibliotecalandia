                                    ...
                                    <div class="dz-body">
                                        ...
                                        <div class="book-footer">
                                            ...
                                            <div class="product-num">
                                                ...
                                                <a href="http://localhost:8000/{{ $livro->vc_livro }}" target="_blank" class="btn btn-primary btnhover btnhover2"> <span>Ler Livro</span></a>
                                    ...
                                    <div class="col-xl-12 col-lg-6">
                                        <div class="dz-shop-card style-5">
                                            ...
                                            <div class="dz-content">
                                                ...
                                                <a href="{{route('site.livro.desc',$livro->id)}}" class="btn btn-outline-primary btn-sm btnhover btnhover2">
                                                    Ver Detalhes</a>
                                            </div>
                                        </div>
                                    </div>
