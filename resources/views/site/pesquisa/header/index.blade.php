...
<div class="page-content bg-grey">
		<section class="content-inner-1 border-bottom">
			<div class="container">
                    ...
                    <div class="col-book style-1">
						<div class="dz-shop-card style-1">
							...
							<div class="dz-content">
								...
								<ul class="dz-tags">
									<li><a href="books-grid-view.html">{{ $livro->categoria }},</a></li>
									<li><a href="books-grid-view.html">{{ $livro->genero }}</a></li>
								</ul>
								<ul class="dz-rating">
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">{{ $livro->preco }}</span>
										<del>$70.00</del>
									</div>
                ...
                @endforeach
					@foreach ($Blivros as $blivro)
                    <div class="col-book style-1">
						<div class="dz-shop-card style-1">
							<div class="dz-media">
								<img src="{{ asset($blivro->vc_path) }}" alt="book">									
							</div>
							<div class="bookmark-btn style-2">
								<input class="form-check-input" type="checkbox" id="flexCheckDefault1">
								<label class="form-check-label" for="flexCheckDefault1">
							...
							<div class="dz-content">
								<h5 class="title"><a href="books-grid-view.html">{{ $blivro->vc_nome }}</a></h5>
								<ul class="dz-tags">
									<li><a href="books-grid-view.html">{{ $blivro->categoria }},</a></li>
									<li><a href="books-grid-view.html">{{ $blivro->genero }}</a></li>
								</ul>
								<ul class="dz-rating">
									<li><i class="flaticon-star text-yellow"></i></li>	
									<li><i class="flaticon-star text-yellow"></i></li>	
								...
								<div class="book-footer">
									<div class="price">
										<span class="price-num">{{ $blivro->preco }}</span>
										<del>$70.00</del>
									</div>
									<a href="shop-cart.html" class="btn btn-secondary box-btn btnhover btnhover2"><i class="flaticon-shopping-cart-1 m-r10"></i> Add to cart</a>
								</div>
