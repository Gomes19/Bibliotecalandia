       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
               ...
               <form action="{{route('relatorio.biblioteca.livros.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="inputState">Categoria</label>
                                <select id="nivel_acesso" class="form-control" name="categoria" style="width: 100%;" >
                           ...
                           <div class="form-group col-md-6">
                                ...
                                @foreach ($sub_categorias as $sub_categoria)
                                    ...
                                    <option value="{{ $sub_categoria->id }}">{{ $sub_categoria->vc_nome }}</option>
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputState">Partileiras</label>
                                <select id="nivel_acesso" class="form-control" name="partileira" style="width: 100%;" >
                                <option value="Todos">Todos</option>
                                @foreach ($partileiras as $partileira)

                                    <option value="{{ $partileira->id }}">{{ $partileira->vc_nome }}</option>
