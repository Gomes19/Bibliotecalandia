...
<div class="content-inner container-fluid pb-0" id="page_layout">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$livro->categoria}}</td>
                                   <td>{{$livro->genero}}</td>
                            <td> <a href="{{asset($livro->vc_livro)}}" target="_blank">{{$livro->vc_livro}}</a> </td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$livro->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('biblioteca.livros.delete', $livro->id)}}">
                                    <span class="btn-inner">
                    ...
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('biblioteca.livros.update',$livro->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                                @include('biblioteca.livros.form')
                ...
                <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('biblioteca.livros.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
  ...
  <script>
      ...
      axios.post('/cadastro/livro', 'rfid=' + rfid)
