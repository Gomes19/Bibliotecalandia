        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
               ...
               @if(Auth::user()->vc_tipo_utilizador==1)
                        ...
                        {{-- <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="{{route('admin.user.list')}}">
                                  ...
                                  <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Horizontal" data-bs-placement="right"> L </i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="{{route('admin.user')}}">
                                    ...
                                    <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Dual Compact" data-bs-placement="right"> C </i>                   
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Utilitarios</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>
                     <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{route('admin.sub_categoria.index')}}" >
                            ...
                            <span class="item-name">Genêro</span>
                           
                        </a>
                       
                    </li> 
                     {{-- <li class="nav-item">
                        <a class="nav-link"  href="{{route('admin.partileira.index')}}" >
                            ...
                            <span class="item-name">Partileira</span>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Livraria Digital</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{route('admin.livros.index')}}" >
                            ...
                            <span class="item-name">Livros</span>
                    ...
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Jogos-BookGames</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link"  href="{{route('CategoriaJogo.index')}}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{route('questionjogo.index')}}" >
                            
                            <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.4" d="M16.191 2H7.81C4.77 2 3 3.78 3 6.83V17.16C3 20.26 4.77 22 7.81 22H16.191C19.28 22 21 20.26 21 17.16V6.83C21 3.78 19.28 2 16.191 2Z" fill="currentColor"></path>
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8.07996 6.6499V6.6599C7.64896 6.6599 7.29996 7.0099 7.29996 7.4399C7.29996 7.8699 7.64896 8.2199 8.07996 8.2199H11.069C11.5 8.2199 11.85 7.8699 11.85 7.4289C11.85 6.9999 11.5 6.6499 11.069 6.6499H8.07996ZM15.92 12.7399H8.07996C7.64896 12.7399 7.29996 12.3899 7.29996 11.9599C7.29996 11.5299 7.64896 11.1789 8.07996 11.1789H15.92C16.35 11.1789 16.7 11.5299 16.7 11.9599C16.7 12.3899 16.35 12.7399 15.92 12.7399ZM15.92 17.3099H8.07996C7.77996 17.3499 7.48996 17.1999 7.32996 16.9499C7.16996 16.6899 7.16996 16.3599 7.32996 16.1099C7.48996 15.8499 7.77996 15.7099 8.07996 15.7399H15.92C16.319 15.7799 16.62 16.1199 16.62 16.5299C16.62 16.9289 16.319 17.2699 15.92 17.3099Z" fill="currentColor"></path>
                            </svg>
                            <span class="item-name">Questões do jogo</span>
                  ...
                  <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Bibliotecas Fisicas</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>
                     <li class="nav-item  ">
                        <a class="nav-link"  href="{{route('admin.biblioteca.index')}}" >
                            ...
                            <span class="item-name">Bibliotecas</span>
                    ...
                    <li><hr class="hr-horizontal"></li>
                      <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Registro de Actividades</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>
                     ...
                     <li><hr class="hr-horizontal"></li>
                      <li class="nav-item static-item">
                        <a class="nav-link static-item disabled text-start" href="#" tabindex="-1">
                            <span class="default-icon">Relatorios</span>
                            <span class="mini-icon" data-bs-toggle="tooltip" title="Home" data-bs-placement="right">-</span>
                        </a>
                    </li>
                        <li class="nav-item mb-lg-5">
                        <a class="nav-link"  href="{{route('relatorio.livros.index')}}" >
                         ...
                         <a class="nav-link"  href="{{route('relatorio.admin.biblioteca.index')}}" >
                    ...
                    @if(Auth::user()->vc_tipo_utilizador==2)
                      <li class="nav-item">
                        <a class="nav-link"  href="{{route('biblioteca.user.index')}}" >
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{route('biblioteca.emprestimos')}}" >
                            ...
                            <span class="item-name">Estudantes</span>
                    ...
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-user" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('biblioteca.livros.index')}}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <span class="item-name">Listar Livros</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('biblioteca.livros.create') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <span class="item-name">Cadastrar Livros</span>
                                    </a>
                                </li>
                    ...
                    {{-- fIM lIVRO bIBLIOTECA --}}

                     {{-- Inicio Empretiimos bIBLIOTECA --}}
                    <li class="nav-item">
                      <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-biblioteca" role="button" aria-expanded="false" aria-controls="sidebar-user">
                                   <i class="icon" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Utilities" data-bs-original-title="Utilities">
                                <svg width="20" class="icon-20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.4" d="M11.9912 18.6215L5.49945 21.864C5.00921 22.1302 4.39768 21.9525 4.12348 21.4643C4.0434 21.3108 4.00106 21.1402 4 20.9668V13.7087C4 14.4283 4.40573 14.8725 5.47299 15.37L11.9912 18.6215Z" fill="currentColor"></path>
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M8.89526 2H15.0695C17.7773 2 19.9735 3.06605 20 5.79337V20.9668C19.9989 21.1374 19.9565 21.3051 19.8765 21.4554C19.7479 21.7007 19.5259 21.8827 19.2615 21.9598C18.997 22.0368 18.7128 22.0023 18.4741 21.8641L11.9912 18.6215L5.47299 15.3701C4.40573 14.8726 4 14.4284 4 13.7088V5.79337C4 3.06605 6.19625 2 8.89526 2ZM8.22492 9.62227H15.7486C16.1822 9.62227 16.5336 9.26828 16.5336 8.83162C16.5336 8.39495 16.1822 8.04096 15.7486 8.04096H8.22492C7.79137 8.04096 7.43991 8.39495 7.43991 8.83162C7.43991 9.26828 7.79137 9.62227 8.22492 9.62227Z" fill="currentColor"></path>
                                ...
                                <span class="item-name">Emprestimos</span>
                                <i class="right-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" class="icon-18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                    </svg>
                            ...
                            <ul class="sub-nav collapse" id="sidebar-biblioteca" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{route('biblioteca.emprestimo.index')}}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="User Profile" data-bs-placement="right"> U </i>
                                        <span class="item-name">Listar Emprestimos</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('biblioteca.emprestimo.create') }}">
                                        <i class="icon">
                                            <svg class="icon-10" width="10" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                        ...
                                        <i class="sidenav-mini-icon" data-bs-toggle="tooltip" title="Add User" data-bs-placement="right"> A </i>
                                        <span class="item-name">Cadastrar Emprestimo</span>
                                    </a>
                                </li>
                    ...
                    {{-- fIM Empretiimos bIBLIOTECA --}}
                     <li class="nav-item">
                        <a class="nav-link"  href="{{route('CategoriaJogo.index')}}" >
                            ...
                            <span class="item-name">Categorias  dos Jogos</span>
                    ...
                    <li><hr class="hr-horizontal"></li>
                      <li class="nav-item static-item">
                        ...
                        <li class="nav-item mb-lg-5">
                        <a class="nav-link"  href="{{route('relatorio.biblioteca.livros.index')}}" >
...
{{-- relatorio.biblioteca.livros.index --}}