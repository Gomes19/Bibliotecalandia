                        ...
                        <tr>
                            ...
                            <td><div class="btn-group card-option">
                                ...
                                <ul class="list-unstyled card-option dropdown-menu dropdown-menu-right">
                                     ...
                                     <li class="dropdown-item -"><a data-toggle="modal" data-target="#exampleModal{{$reserva->id}}" data-whatever="@getbootstrap" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="feather icon-refresh-cw"></i> Editar</a></li>
                                    <li class="dropdown-item "><a href="{{route('admin.reserva.delete', $reserva->id)}}"><i class="feather icon-trash"></i> Eliminar</a></li>
                                </ul>
                            </div></td>
                        </tr>
                            ...
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">{{$reserva->marca}} {{$reserva->modelo}}</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form action="{{route('admin.reserva.update',$reserva->id)}}" method="post" enctype="multipart/form-data">
                                            @csrf
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('admin.reserva.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @include('admin.reserva.form')
