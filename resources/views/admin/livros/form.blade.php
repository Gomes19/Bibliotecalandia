         <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="titulo" class="form-control" placeholder="Nome do Livro"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="editora" class="form-control" placeholder="TAG RFID"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="ano_publicacao" class="form-control" name="ano"
