                ...
                <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('livros.associarRfid')}}" method="post" enctype="multipart/form-data">
                                @csrf
...
@if (session('eliminada'))
    <script>
        Swal.fire(
            'Dados da Biblioteca Eliminado com sucesso!',
            '',
            'success'
        )
    </script>
...
<script>
    Swal.fire(
        'Dados da Biblioteca editado com sucesso!',
        '',
        'success'
    )
</script>
...
<script>
Swal.fire(
    'ERro ao editar Dados da Biblioteca!',
    '',
    'error'
)
</script>
...
<script>
    Swal.fire(
        'Dados da Biblioteca Cadastrado Com Sucesso!',
        '',
        'success'
    )
</script>
...
<script>
Swal.fire(
    'Erro ao cadastrar Dados da Biblioteca!',
    '',
    'success'
)
</script>
