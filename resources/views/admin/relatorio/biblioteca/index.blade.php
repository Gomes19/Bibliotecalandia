       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
               ...
               <form action="{{route('relatorio.admin.biblioteca.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                
                                
                            <div class="form-group col-md-6">
                                <label for="inputState">Bibliotecas</label>
                                <select id="bibliotecas" class="form-control" name="bibliotecas" style="width: 100%;" >
                           ...
                           <div class="form-group col-md-6">
                                <label for="inputState">Tipo de Biblioteca</label>
